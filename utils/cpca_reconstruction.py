...
def write_results(phase_ts, rotation, n, mask, header, file_format, out_prefix):
...
def cpca_recon(cpca_res, rotation, file_format, mask, header, out_prefix, n_bins):
    ...
    for n in range(n_comps):
        ...
        bin_indx_all.append(bin_indx)
        bin_centers_all.append(bin_centers)
        write_results(phase_ts, rotation, n, mask, header, file_format, out_prefix)
    ...
    metadata = {"phase_bin_index": bin_indx_all, "phase_bin_centers": bin_centers_all}
